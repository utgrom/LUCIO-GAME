  ...
  const GAME_CONFIG = {
    ...
    visualPresets: {
      ...
      shinyModifier: {
        ...
        shine: { width: 11, speed: 1.1, angle: -42, intensity: 0.85, frequency: 3.8 },
        pulse: { speed: 1.35, intensity: 0.5, scale: 1.035 },
      },
    },
    defaultEffects: {
      bronze: { glow: true, sparkles: false, diamond: false, cosmic: false, shiny: false, shinySparkles: false, shine: false, pulse: false, idle: true },
      silver: { glow: true, sparkles: false, diamond: false, cosmic: false, shiny: false, shinySparkles: false, shine: false, pulse: false, idle: true },
      gold: { glow: true, sparkles: true, diamond: false, cosmic: false, shiny: false, shinySparkles: false, shine: false, pulse: false, idle: true },
      ruby: { glow: true, sparkles: true, diamond: false, cosmic: false, shiny: false, shinySparkles: false, shine: false, pulse: true, idle: true },
      diamond: { glow: true, sparkles: true, diamond: true, cosmic: false, shiny: false, shinySparkles: false, shine: false, pulse: true, idle: true },
      cosmic: { glow: true, sparkles: true, diamond: false, cosmic: true, shiny: false, shinySparkles: false, shine: false, pulse: true, idle: true },
      mystery: { glow: true, sparkles: false, diamond: false, cosmic: false, shiny: false, shinySparkles: false, shine: false, pulse: true, idle: true },
    },
    backpacks: {
      normal: {
        label: "Normal",
    ...
    opening: {
      ...
      rewardTimingOverrides: {
        ...
        shiny: {
          default: { riseDuration: 2400, revealDuration: 3000, mysterySwapPoint: 0.65 },
          diamond: { mysterySwapPoint: 0.95 },
          cosmic: { mysterySwapPoint: 0.95 },
        },
      },
    },
    performance: {
