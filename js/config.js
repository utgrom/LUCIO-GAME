(function () {
  ...
  const GAME_CONFIG = {
    ...
    defaultEffects: {
      ...
      diamond: { glow: true, sparkles: true, diamond: true, cosmic: false, shiny: false, shinySparkles: false, shine: true, lightning: false, pulse: true, idle: true },
      cosmic: { glow: true, sparkles: true, diamond: false, cosmic: true, shiny: false, shinySparkles: false, shine: true, lightning: false, pulse: true, idle: true },
